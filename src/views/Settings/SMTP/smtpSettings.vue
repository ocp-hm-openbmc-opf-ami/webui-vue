    ...
    onFileUpload(file, type, config) {
      if (file) {
        ...
        this.$store
          ...
          .then((success) => {
            this.primaryConfiguration = false;
            this.updateSMTPPrimaryData();
            this.secondaryConfiguration = false;
            this.updateSMTPSecondaryData();
